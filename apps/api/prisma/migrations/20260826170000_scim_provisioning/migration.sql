...
ALTER TABLE "ScimProvisioningConnection" ADD CONSTRAINT "ScimProvisioningConnection_samlConnectionId_fkey" FOREIGN KEY ("samlConnectionId") REFERENCES "SamlConnection"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "ScimUser" ADD CONSTRAINT "ScimUser_provisioningConnectionId_tenantId_fkey" FOREIGN KEY ("provisioningConnectionId", "tenantId") REFERENCES "ScimProvisioningConnection"("id", "tenantId") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "ScimUser" ADD CONSTRAINT "ScimUser_tenantMembershipId_fkey" FOREIGN KEY ("tenantMembershipId") REFERENCES "TenantMembership"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "ScimUser" ADD CONSTRAINT "ScimUser_externalIdentityId_fkey" FOREIGN KEY ("externalIdentityId") REFERENCES "ExternalIdentity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "ScimProvisioningConnection" ADD CONSTRAINT "ScimProvisioningConnection_identity_matches_saml" CHECK ("identityConnectionId" IS NOT NULL);
